...
public class FishGame extends JComponent {
    ...
    //Title of the window
    String title = "Just Keep Swimming";
    ...
    public void paintComponent(Graphics g) {
        ...
        if (menu) {
         ...
         g.drawString("Just Keep Swimming", WIDTH / 4, HEIGHT / 4);
         
         // instruction to start the game and what to do
         g.setColor(Color.ORANGE);
         g.setFont(smallerFont);
         g.drawString("Press 'SPACE' to start", WIDTH / 3, 250);
         
         g.setColor(darkPink);
         g.drawString("Dodge These:", WIDTH / 3, 325);
         g.drawString("Collect These:", WIDTH / 3, 400);
         
         //examples of obstacles
         g.setColor(Color.RED);
         g.fillOval(450, 285, obstacleWidth, obstacleHeight);
         
         // examples of fish food
         g.setColor(fishFood);
         g.fillOval(450, 380, 25, 25);
         g.fillOval(287, 478, 25, 25);
         
         // hint
         g.setColor(darkPink);
         g.drawString("Hint: Every 5      You collect, your speed increases", 125, 500);
    ...
    public void run() {
        ...
        while (!done) {
            ...
            if (menu == false && gameOn) {
                ...
                lineX2 = (int) (lineX2 - obstacleSpeed) - 6;
                lineX3 = (int) (lineX3 - obstacleSpeed) - 6;
                lineX = (int) (lineX - obstacleSpeed) - 6;
